...
public class Menu {
    ...
    public static void MostrarMenu() {
        ...
        while (option != 0) {
            ...
            System.console().println("+----------- MENU DE INVENTARIO -----------+");
            System.console().println("|---  1 - Cadastrar Inventário        -----|");
            System.console().println("|---  2 - Alterar Inventário          -----|");
            System.console().println("|---  3 - Remover Inventário          -----|");
            System.console().println("|---  4 - Consultar Inventário        -----|");
            System.console().println("|---  0 - Sair                        -----|");
