...
public class Projetor extends Eletronico{
    
    public Projetor(int altura, int comprimento, String cor, int largura, Marca marca, String material, Superficie superficie) {
